...
const navigationMenuTriggerStyle = cva(
  "group/navigation-menu-trigger h-9 px-2.5 py-1.5 text-sm font-medium inline-flex w-max items-center justify-center rounded-lg transition-all outline-none hover:bg-muted focus:bg-muted focus-visible:ring-3 focus-visible:ring-ring/50 focus-visible:outline-1 disabled:pointer-events-none disabled:opacity-50 data-open:bg-muted/50 data-open:hover:bg-muted data-open:focus:bg-muted data-popup-open:bg-muted/50 data-popup-open:hover:bg-muted"
)
...
const NavigationMenuIndicator = ({
  ...
  <NavigationMenuPrimitive.Icon
    ...
    className={cn(
      "h-1.5 top-full z-1 flex items-end justify-center overflow-hidden data-[state=hidden]:animate-out data-[state=hidden]:fade-out data-[state=visible]:animate-in data-[state=visible]:fade-in",
      className
    )}
    {...props}
  >
